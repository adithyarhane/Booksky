...
const VerifyAccount = () => {
  ...
  const { handleChange, handleKeyDown, handlePaste } = useUIContext();
            ...
            <div className="flex justify-between gap-2 md:gap-4">
              {otp.map((data, index) => (
                <input
                  ...
                  value={data}
                  onChange={(e) =>
                    handleChange(e.target, index, otp, setOtp, inputRefs)
                  }
                  onKeyDown={(e) => handleKeyDown(e, index, otp, inputRefs)}
                  onPaste={(e) => handlePaste(e, otp, inputRefs, setOtp)} // --- ATTACHED HERE ---
