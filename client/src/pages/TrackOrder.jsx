...
const TrackOrder = () => {
  ...
  const { trackSteps, orderData, getOrderData } = useOrderContext();
  ...
  return (
    <main className="min-h-screen bg-[#f5f1ea] text-[#1A1A1A] selection:bg-[#7a4a2e] selection:text-white pb-24">
      <div className="max-w-5xl mx-auto px-6 pt-28 lg:pt-32">
        {/* --- NAVIGATION --- */}
        <button
          onClick={() => navigate(-1)}
            ...
            <div className="relative space-y-12 pl-8">
              ...
              {trackSteps.map((step, idx) => (
                <div key={idx} className="relative group">
                  <div
                    className={`absolute -left-7.5 top-1 w-6 h-6 rounded-full border-4 border-[#f5f1ea] z-10 transition-colors duration-500 ${
