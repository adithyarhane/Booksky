...
const BookListFilterSec = () => {
  const { setSearch, search, category, setSearchParams } = useBookContext();
  const { viewMode, setViewMode, categories } = useUIContext();
...
export default BookListFilterSec;
