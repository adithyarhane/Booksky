...
const MobileMenu = () => {
  ...
  const { navLinks, isSidebarOpen, setIsSidebarOpen } = useUIContext();
          ...
          <div className="mt-auto pt-8">
            {!isLoggedIn ? (
              ...
              <div className="space-y-3">
                ...
                <button className="flex items-center justify-center gap-2 w-full py-4 text-[#A1887F] hover:text-red-700 transition-colors text-[11px] font-bold uppercase tracking-widest">
                  <FiLogOut /> Sign Out
                </button>
              </div>
            )}
